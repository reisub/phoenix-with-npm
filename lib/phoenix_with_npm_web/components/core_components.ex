defmodule PhoenixWithNpmWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixWithNpmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixWithNpmWeb.Gettext, "errors", msg, opts)
    end
  end
